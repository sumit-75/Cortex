...
export function PostGrid({ posts, folders = [] }: PostGridProps) {
  ...
  if (posts.length === 0) {
    return (
      <div className="p-12 border border-dashed border-slate-800 rounded-3xl text-center bg-slate-900/30 max-w-2xl mx-auto">
        ...
        <h3 className="text-base font-semibold text-slate-200">No saved posts in this view</h3>
